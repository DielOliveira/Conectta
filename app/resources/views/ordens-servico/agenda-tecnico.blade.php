...
<head>
    ...
    <style>
        :root{--brand:#d97706;--brand-dark:#92400e;--ink:#172033;--muted:#667085;--line:#e5e7eb;--surface:#fff;--soft:#f8fafc;--danger:#b42318;--success:#067647}*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:linear-gradient(180deg,#fff7ed 0,#f5f6f8 280px);color:var(--ink);font:16px/1.5 system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.wrap{max-width:760px;margin:auto;padding:18px}.card{background:rgba(255,255,255,.98);border:1px solid rgba(229,231,235,.9);border-radius:20px;padding:20px;margin-bottom:16px;box-shadow:0 10px 30px rgba(15,23,42,.06)}.hero{padding:24px;background:linear-gradient(135deg,#fffbeb,#fff7ed);border-color:#fed7aa}.kicker{display:block;color:var(--brand-dark);font-size:.76rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.hero h1{margin:5px 0 6px;font-size:1.6rem;line-height:1.2}.hero p,.muted{margin:0;color:var(--muted)}h2{font-size:1.15rem;margin:0 0 5px}.hint{margin:0 0 17px;color:var(--muted);font-size:.9rem}.tabs{display:grid;grid-template-columns:1fr 1fr;gap:5px;margin-bottom:16px;padding:5px;border:1px solid var(--line);border-radius:16px;background:#fff;box-shadow:0 8px 24px rgba(15,23,42,.05);position:sticky;top:8px;z-index:10}.tab{display:flex;align-items:center;justify-content:center;gap:8px;min-height:46px;padding:9px;border-radius:11px;color:var(--muted);font-size:.91rem;font-weight:800;text-decoration:none}.tab.active{background:#fff7ed;color:var(--brand-dark);box-shadow:inset 0 0 0 1px #fed7aa}.tab svg,.week-button svg,.route-link svg{width:18px;height:18px;fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}.choice-label{display:block;margin:14px 0 7px;font-size:.78rem;font-weight:850;color:var(--muted);text-transform:uppercase;letter-spacing:.04em}.choices{display:grid;grid-template-columns:1fr 1fr;gap:5px;padding:5px;border:1px solid var(--line);border-radius:14px;background:var(--soft)}.choice{position:relative}.choice input{position:absolute;opacity:0;pointer-events:none}.choice span{display:flex;align-items:center;justify-content:center;min-height:43px;padding:8px;border-radius:9px;color:var(--muted);font-size:.84rem;font-weight:800;text-align:center}.choice input:checked+span{background:#fff;color:var(--brand-dark);box-shadow:0 2px 7px rgba(15,23,42,.1)}.choice.danger input:checked+span{color:var(--danger);box-shadow:inset 0 0 0 1px #fecaca}.form-grid{display:grid;grid-template-columns:1.35fr 1fr 1fr;gap:12px;margin-top:14px}label{display:block;font-size:.86rem;font-weight:750}input{width:100%;min-height:46px;margin-top:5px;padding:10px 12px;border:1px solid #d0d5dd;border-radius:11px;background:#fff;color:var(--ink);font:inherit}input:focus{outline:0;border-color:#f59e0b;box-shadow:0 0 0 3px rgba(245,158,11,.16)}button,.button{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-height:46px;border:0;border-radius:12px;padding:11px 16px;background:var(--brand);color:#fff;font:inherit;font-weight:780;cursor:pointer;text-decoration:none}.add{width:100%;margin-top:16px}.day{margin-top:18px}.day:first-child{margin-top:4px}.day-title{display:flex;align-items:center;gap:9px;margin:0 0 9px;font-size:.93rem;text-transform:capitalize}.day-title:after{content:"";height:1px;flex:1;background:var(--line)}.slot{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:14px;margin-top:8px;border:1px solid var(--line);border-radius:14px;background:var(--soft)}.slot.blocked{border-color:#fecaca;background:#fff7f7}.time{font-size:1.08rem;font-weight:800}.slot-meta{display:block;color:var(--muted);font-size:.82rem}.type-badge{display:inline-flex;margin-top:5px;padding:3px 7px;border-radius:999px;background:#dcfce7;color:#166534;font-size:.7rem;font-weight:850}.type-badge.blocked{background:#fee2e2;color:#991b1b}.delete{min-height:38px;padding:8px 11px;background:#fff;color:var(--danger);border:1px solid #fecaca}.locked{display:inline-flex;align-items:center;padding:6px 9px;border-radius:999px;background:#fef3c7;color:#92400e;font-size:.76rem;font-weight:750}.week-nav{display:grid;grid-template-columns:44px 1fr 44px;align-items:center;gap:9px;margin:16px 0}.week-button{display:flex;align-items:center;justify-content:center;height:44px;border:1px solid var(--line);border-radius:12px;background:#fff;color:var(--ink);text-decoration:none}.week-label{text-align:center}.week-label strong{display:block;font-size:.96rem}.week-label span{display:block;color:var(--muted);font-size:.78rem}.today-link{display:block;width:max-content;margin:-5px auto 16px;color:var(--brand-dark);font-size:.82rem;font-weight:800;text-decoration:none}.week-field{padding:12px;border:1px solid #fed7aa;border-radius:12px;background:#fff7ed;text-align:center;font-size:.86rem}.os-day{margin-top:20px}.os-day:first-of-type{margin-top:4px}.os-card{position:relative;overflow:hidden;margin-top:10px;padding:15px;border:1px solid var(--line);border-radius:16px;background:#fff;box-shadow:0 5px 16px rgba(15,23,42,.045)}.os-card:before{content:"";position:absolute;left:0;top:0;bottom:0;width:4px;background:#f59e0b}.os-top{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.os-number{display:block;font-size:.75rem;font-weight:850;letter-spacing:.04em;color:var(--muted)}.os-type{display:block;margin-top:1px;font-size:1.03rem;font-weight:850}.status{flex:0 0 auto;display:inline-flex;padding:5px 8px;border-radius:999px;font-size:.7rem;font-weight:850;line-height:1.15;text-align:center}.status-blue{background:#dbeafe;color:#1d4ed8}.status-amber{background:#fef3c7;color:#92400e}.status-green{background:#dcfce7;color:#166534}.status-red{background:#fee2e2;color:#991b1b}.status-gray{background:#f1f5f9;color:#475569}.status-purple{background:#f3e8ff;color:#7e22ce}.os-details{display:grid;gap:7px;margin:13px 0 0;padding-top:12px;border-top:1px solid #eef2f6}.detail{display:grid;grid-template-columns:68px 1fr;gap:8px;font-size:.86rem}.detail span{color:var(--muted)}.detail strong{font-weight:720;overflow-wrap:anywhere}.route-link{display:flex;align-items:center;justify-content:center;gap:7px;width:100%;min-height:42px;margin-top:13px;border:1px solid #fed7aa;border-radius:11px;background:#fff7ed;color:var(--brand-dark);font-size:.86rem;font-weight:820;text-decoration:none}.empty{text-align:center;padding:28px 12px;color:var(--muted)}.empty-icon{display:grid;place-items:center;width:48px;height:48px;margin:0 auto 10px;border-radius:50%;background:#fff7ed;color:var(--brand);font-size:1.4rem}.ok,.error{padding:13px 15px;border-radius:12px;margin-bottom:14px}.ok{background:#dcfce7;color:#166534}.error{background:#fee2e2;color:#991b1b}.footer{text-align:center;color:#98a2b3;font-size:.78rem;padding:4px 0 18px}.hidden{display:none!important}
...
<main class="wrap">
    ...
    @if($aba === 'agenda')
        <section class="card">
            <h2>Adicionar disponibilidade ou bloqueio</h2>
            <p class="hint">Inclua horários livres ou bloqueie períodos. O bloqueio sempre prevalece sobre um horário disponível.</p>
            <form method="post" action="{{ route('tecnicos.agenda.store', $token) }}">@csrf
                <span class="choice-label">Período</span>
                <div class="choices">
                    <label class="choice"><input type="radio" name="modo" value="dia" {{ $modoCriacao === 'dia' ? 'checked' : '' }}><span>Um dia</span></label>
                    <label class="choice"><input type="radio" name="modo" value="semana" {{ $modoCriacao === 'semana' ? 'checked' : '' }}><span>Semana</span></label>
                </div>
                <span class="choice-label">Tipo</span>
                <div class="choices">
                    <label class="choice"><input type="radio" name="tipo" value="disponibilidade" {{ $tipoCriacao === 'disponibilidade' ? 'checked' : '' }}><span>Disponível</span></label>
                    <label class="choice danger"><input type="radio" name="tipo" value="bloqueio" {{ $tipoCriacao === 'bloqueio' ? 'checked' : '' }}><span>Bloqueio</span></label>
                </div>
                <div id="week-picker" class="{{ $modoCriacao === 'semana' ? '' : 'hidden' }}">
                    <div class="week-nav">
                        <a class="week-button" aria-label="Semana anterior" href="{{ route('tecnicos.agenda', ['token' => $token, 'modo_agenda' => 'semana', 'semana' => $inicioSemana->subWeek()->format('Y-m-d')]) }}"><svg viewBox="0 0 24 24"><path d="m15 18-6-6 6-6"/></svg></a>
                        <div class="week-label"><strong>{{ $inicioSemana->translatedFormat('d M') }} — {{ $inicioSemana->addDays(4)->translatedFormat('d M') }}</strong><span>Segunda a sexta</span></div>
                        <a class="week-button" aria-label="Próxima semana" href="{{ route('tecnicos.agenda', ['token' => $token, 'modo_agenda' => 'semana', 'semana' => $inicioSemana->addWeek()->format('Y-m-d')]) }}"><svg viewBox="0 0 24 24"><path d="m9 18 6-6-6-6"/></svg></a>
                    </div>
                    <input type="hidden" name="data" value="{{ $inicioSemana->format('Y-m-d') }}" data-week-date>
                </div>
                <div class="form-grid">
                    <label id="day-picker" class="{{ $modoCriacao === 'semana' ? 'hidden' : '' }}">Data<input type="date" name="data" min="{{ today()->format('Y-m-d') }}" value="{{ old('data', today()->addDay()->format('Y-m-d')) }}" data-day-date></label>
                ...
                <button class="add" type="submit">Salvar na agenda</button>
            </form>
        </section>
        <section class="card">
            <h2>Agenda da semana</h2>
            <p class="hint">Períodos bloqueados ficam indisponíveis mesmo quando existe disponibilidade no mesmo horário.</p>
            <div class="week-nav">
                <a class="week-button" aria-label="Semana anterior" href="{{ route('tecnicos.agenda', ['token' => $token, 'modo_agenda' => $modoCriacao, 'semana' => $inicioSemana->subWeek()->format('Y-m-d')]) }}"><svg viewBox="0 0 24 24"><path d="m15 18-6-6 6-6"/></svg></a>
                <div class="week-label"><strong>{{ $inicioSemana->translatedFormat('d M') }} — {{ $inicioSemana->addDays(4)->translatedFormat('d M') }}</strong><span>{{ $inicioSemana->year }}</span></div>
                <a class="week-button" aria-label="Próxima semana" href="{{ route('tecnicos.agenda', ['token' => $token, 'modo_agenda' => $modoCriacao, 'semana' => $inicioSemana->addWeek()->format('Y-m-d')]) }}"><svg viewBox="0 0 24 24"><path d="m9 18 6-6-6-6"/></svg></a>
            </div>
            @forelse($disponibilidades->groupBy(fn($item) => $item->data->format('Y-m-d')) as $data => $periodos)
                <div class="day">
                    ...
                    @foreach($periodos as $periodo)
                        <div class="slot {{ $periodo->isBloqueio() ? 'blocked' : '' }}">
                            <div><span class="time">{{ substr($periodo->hora_inicio,0,5) }} às {{ substr($periodo->hora_fim,0,5) }}</span><span class="slot-meta">{{ \Carbon\CarbonImmutable::parse($periodo->hora_inicio)->diffInMinutes(\Carbon\CarbonImmutable::parse($periodo->hora_fim)) / 60 }} hora(s)</span><span class="type-badge {{ $periodo->isBloqueio() ? 'blocked' : '' }}">{{ $periodo->isBloqueio() ? 'Bloqueado' : 'Disponível' }}</span></div>
...
document.querySelectorAll('input[name="modo"]').forEach(function (input) {
    input.addEventListener('change', function () {
        var semanal = this.value === 'semana';
        document.getElementById('week-picker').classList.toggle('hidden', ! semanal);
        document.getElementById('day-picker').classList.toggle('hidden', semanal);
        document.querySelector('[data-week-date]').disabled = ! semanal;
        document.querySelector('[data-day-date]').disabled = semanal;
    });
});
