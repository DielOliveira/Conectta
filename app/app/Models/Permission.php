...
class Permission extends Model
{
    ...
    public static function catalogo(): array
    {
        return [
            ...
            self::ESTOQUE_ESCRITA => ['label' => 'Estoque - Escrita', 'modulo' => 'Estoque', 'acao' => 'Escrita', 'ordem' => 70],
            self::ESTOQUE_LEITURA => ['label' => 'Estoque - Leitura', 'modulo' => 'Estoque', 'acao' => 'Leitura', 'ordem' => 80],
            self::FATURAMENTO_ESCRITA => ['label' => 'Faturamento - Escrita', 'modulo' => 'Faturamento', 'acao' => 'Escrita', 'ordem' => 90],
            self::FATURAMENTO_LEITURA => ['label' => 'Faturamento - Leitura', 'modulo' => 'Faturamento', 'acao' => 'Leitura', 'ordem' => 100],
            self::FINANCEIRO_ESCRITA => ['label' => 'Financeiro - Escrita', 'modulo' => 'Financeiro', 'acao' => 'Escrita', 'ordem' => 110],
            self::FINANCEIRO_LEITURA => ['label' => 'Financeiro - Leitura', 'modulo' => 'Financeiro', 'acao' => 'Leitura', 'ordem' => 120],
        ];
    }
