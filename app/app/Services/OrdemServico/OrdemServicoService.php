...
class OrdemServicoService
{
    ...
    public function solicitarConferencia(OrdemServico $ordem): void
    {
        ...
        if (in_array($ordem->tipo, [OrdemServicoTipo::INSTALACAO, OrdemServicoTipo::MANUTENCAO], true) && $ordem->bloqueio === null) {
            throw ValidationException::withMessages(['bloqueio' => 'Informe se há bloqueio.']);
        }
