...
- A protecao central de status fica em `App\Services\Estoque\EquipamentoStatusWorkflow` e nos eventos dos models `Chip` e `Rastreador`; fluxos autorizados executam a mudanca dentro de `EquipamentoStatusWorkflow::executar()`.
- A regra e coberta por `tests/Feature/EquipamentoStatusWorkflowTest.php` e pelos testes de estoque, cadastro de rastreadores e OS. Na implementacao de 2026-08-19, a suite completa passou com 115 testes e 531 assercoes.
